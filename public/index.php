...
$router->get('/api/admin/system/settings', 'AdminController@getSettings');
$router->post('/api/admin/system/settings', 'AdminController@saveSettings');
$router->get('/api/admin/system/backup', 'AdminController@downloadBackup');
